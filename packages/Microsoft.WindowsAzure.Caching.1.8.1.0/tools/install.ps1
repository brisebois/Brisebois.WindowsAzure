...
$ccProjectsCount = GetCount $ccProjects

if ($ccProjectsCount -lt 1)
{
    Write-Host 'No Windows Azure project was found in this solution.'

    # Since rest of the segments deal with ccproj, skip to last segment
