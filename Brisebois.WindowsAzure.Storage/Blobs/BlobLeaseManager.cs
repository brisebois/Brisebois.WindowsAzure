...
public class BlobLeaseManager : IDisposable
{
    ...
    public void Dispose()
    {
        acquiredLeases.ToList().ForEach(pair => pair.Value.KeepAlive.Dispose());
    }
    ...
    public void ReleaseLease(CloudBlockBlob blob)
    {
        ...
        {
            Trace.WriteLine(string.Format(CultureInfo.InvariantCulture, FAILED_ATTEMPT_AT_RELEASING_BLOB_LEASE,
                                          blob.Name,
                                          leaseId));
        }
    }
    ...
    private bool RenewLease(CloudBlockBlob blob)
    {
        ...
        try
        {
            ...
            Trace.WriteLine(string.Format(CultureInfo.InvariantCulture, RENEWED_LEASE, name));
        ...
        catch (StorageException)
        {
            ...
            Trace.WriteLine(string.Format(CultureInfo.InvariantCulture, REMOVED_LEASE_FROM_ACQUIREDLEASES, name));
