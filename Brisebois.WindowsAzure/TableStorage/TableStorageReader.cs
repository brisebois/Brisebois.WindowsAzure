...
namespace Brisebois.WindowsAzure.TableStorage
{
    public class TableStorageReader
    {
        ...
        public async Task<ICollection<TEntity>> Execute<TEntity>(CloudTableQuery<TEntity> query)
            ...
            return await Task.Run(() =>
                {
                    ...
                    var cached = new CloudTableQueryCache<TEntity>(query, cachePolicy, cacheHint);
